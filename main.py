   ...
   # Audio Sounds
    ...
    def display_stocks_for_buying(self):
        ...
        for stock in stocks:
            ...
            stock_button = tk.Button(self.root, text=change_text, command=lambda s=stock: self.buy_stock(s), fg=color, width=adjust_width(25, self.reference_width, self.current_width), bg='black', borderwidth=5, font=("System", adjust_font_size(18, self.reference_width, self.current_width)))
